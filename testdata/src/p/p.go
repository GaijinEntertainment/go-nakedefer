...
func testCase2() {
	...
	defer s.RetNothing()  // ignore
	defer s.RetErr()      // want "deferred call should not return anything"
	defer s.RetInAndErr() // want "deferred call should not return anything"
}
